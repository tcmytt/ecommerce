        ...
        public void run(String... args) throws Exception {
                ...
                if (countPermissions == 0) {
                        ...
                        permissions.add(new Permission("Get a product by id", "/api/v1/products/{id}", "GET",
                                        "PRODUCTS"));
                        permissions.add(new Permission("Get all products with pagination", "/api/v1/products", "GET",
                                        "PRODUCTS"));
                        ...
                        permissions.add(new Permission("Forgot password", "/api/v1/auth/forgot-password", "POST",
                                        "AUTH"));
                        permissions.add(new Permission("Reset password", "/api/v1/auth/reset-password", "POST",
                                        "AUTH"));
                ...
                if (countCategories == 0) {
                        Category vehicles = new Category(null, "Vehicles", "All types of vehicles", null,
                                        "vehicles.jpg", null);
                        Category fashion = new Category(null, "Fashion", "Clothing and accessories", null,
                                        "fashion.jpg", null);
                        ...
                        Category technology = new Category(null, "Technology", "Electronic devices and gadgets", null,
                                        "technology.jpg", null);
                        Category medicine = new Category(null, "Medicine", "Healthcare and wellness products", null,
                                        "medicine.jpg",
                                        null);
                        ...
                        Category bicycles = new Category(null, "Bicycles", "Cycling equipment", vehicles,
                                        "bicycles.jpg", null);

                        Category shirts = new Category(null, "Shirts", "Upper body clothing", fashion, "shirts.jpg",
                                        null);
                        ...
                        Category seafood = new Category(null, "Seafood", "Marine-based food", food, "seafood.jpg",
                                        null);
                        ...
                        Category smartphones = new Category(null, "Smartphones", "Mobile phones", technology,
                                        "smartphones.jpg",
                                        null);
                        Category laptops = new Category(null, "Laptops", "Portable computers", technology,
                                        "laptops.jpg", null);
                        Category headphones = new Category(null, "Headphones", "Audio devices", technology,
                                        "headphones.jpg", null);

                        Category supplements = new Category(null, "Supplements", "Health supplements", medicine,
                                        "supplements.jpg",
                                        null);
                        Category medications = new Category(null, "Medications", "Prescription drugs", medicine,
                                        "medications.jpg",
                                        null);

                        Category novels = new Category(null, "Novels", "Fictional stories", books, "novels.jpg", null);
                        Category textbooks = new Category(null, "Textbooks", "Educational materials", books,
                                        "textbooks.jpg", null);
                        Category comics = new Category(null, "Comics", "Illustrated stories", books, "comics.jpg",
                                        null);
